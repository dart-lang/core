...
class Usages extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(4)
  $core.List<Usage> get calls => $_getList(1);

  @$pb.TagNumber(5)
  $core.List<Usage> get instances => $_getList(2);
}
...
class Identifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Identifier', package: const $pb.PackageName(_omitMessageNames ? '' : 'usages'), createEmptyInstance: create)
    ..aOM<Uri>(1, _omitFieldNames ? '' : 'uri', subBuilder: Uri.create)
  ...
  Uri get uri => $_getN(0);
  @$pb.TagNumber(1)
  set uri(Uri v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasUri() => $_has(0);
  @$pb.TagNumber(1)
  void clearUri() => clearField(1);
  @$pb.TagNumber(1)
  Uri ensureUri() => $_ensure(0);
