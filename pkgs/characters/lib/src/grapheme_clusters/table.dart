...
const _stateMachine = '\n\x00\x14\x14\x14ZF\x00\x1e(2<2<d\x14\x14\x14xy\n\x00'
    '\x14\x14\x14ZF\x01\x1e(2<2<d\x14\x14\x14xy\n\x00\x14\x15\x15ZF\x00\x1e(2<2'
    '<d\x15\x15\x15xy\n\x00\x15\x15\x15[G\x00\x1f)3=3=e\x15\x15\x15xy\n\x00\x14'
    '\x15\x15ZF\x00\x1e)3<3=d\x15\x15\x15xy\n\x00\x14\x15\x15ZF\x00\x1e(3=2<d'
    '\x15\x15\x15xy\n\x00\x14\x15\x15ZF\x00\x1e(2=2<d\x15\x15\x15xy\n\x00\x14G'
    '\x15ZF\x00\x1e(2<2<dQGGxy\n\x00\x14\x15\x15ZG\x00\x1e(2<2<d\x15\x15\x15xy'
    '\n\x00\x14\x15\x15\x15F\x00\x1e(2<2<d\x15\x15\x15xy\n\x00\x14\x15\x15ZF'
    '\x00\x1e(2<2<deeoxy\n\x00\x14\x15\x15ZF\x00\x1e(2<2<eoooxy\v\x01\x15\x15'
    '\x15[G\x01\x1f)3=3=e\x15\x15\x15yy\n\x00\x14\x14\x14ZF\x00\x1e(2<2<d\x14'
    '\x14\x14yy';
int move(int state, int inputCategory) =>
    _stateMachine.codeUnitAt(((state & ~1) << 1) + inputCategory);

const _backStateMachine = '\x00\x00\x14\x1e\x1eZF\n\x14(2<((d\x1e\x1e\x1exy\x01'
    '\x00\x14\x1e\x1eZF\n\x14(2<((d\x1e\x1e\x1exy\x00\x00\x14\x1e\x1eZF\n\x15(2'
    '<((d\x1e\x1e\x1exy\x00\x00\x15\x1f\x1f[G\n\x15)3=))e\x1f\x1f\x1fxy\x00\x00'
    '\x14\x1e\x1eZF\n\x15)2<((d\x1e\x1e\x1exy\x00\x00\x14\x1e\x1eZF\n\x15)3<)(d'
    '\x1e\x1e\x1exy\x00\x00\x14\x1e\x1eZF\n\x15(3=))d\x1e\x1e\x1exy\x00\x00\x14'
    '\x1e\x1eZF\n\x15(2<((d\x96\x1e\x1exyyyyQyoGyyyyyyyyyQQyy\x00\x00\x14\x1e'
    '\x1e\x8cF\n\x15(2<((d\x1e\x1e\x1exy\x00\x00\x14\x1e\x1eZF\n\x15(2<((d\xa0'
    '\xa0ªxy\x00\x00\x14\x1e\x1ePF\n\x15(2<((d\x1e\x1e\x1exy\x01\x01\x15\x1f'
    '\x1f[G\v\x15)3=))e\x1f\x1f\x1fyy\x00\x00\x14\x1e\x1eZF\n\x14(2<((d\x1e\x1e'
    '\x1eyy';
int moveBack(int state, int inputCategory) =>
    _backStateMachine.codeUnitAt(((state & ~1) << 1) + inputCategory);
