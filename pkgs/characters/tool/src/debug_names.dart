...
final backStateNames = List<String>.filled(backStateWithLACount, "")
  ...
  ..[stateT] = "T"
  ..[idStatePictographic] = "Pictographic"
  ..[idStateZWJPictographic] =
      "ZWJPictographic|RegionalOdd" // Known disjoint look-ahead
  ..[idStateRegionalSingle] = "RegionalSingle"
  ..[idStateEoTNoBreak] = "EoTNoBreak"
  ..[idStateInC] = "InC"
  ..[idStateRegionalEven] = "RegionalEven"
  ..[idStateRegionalLookahead] = "RegionalLookahead"
  ..[idStateZWJPictographicLookahead] = "ZWJPictographicLookahead"
  ..[idStateInCLookahead] = "InCLookahead"
  ..[idStateInCLLookahead] = "InCLLookahead";
...
final backStateShortNames = List<String>.filled(backStateWithLACount, "")
  ...
  ..[stateT] = "T"
  ..[idStatePictographic] = "Pic"
  ..[idStateZWJPictographic] = "LA"
  ..[idStateRegionalSingle] = "Reg"
  ..[idStateEoTNoBreak] = "EoTN"
  ..[idStateInC] = "InC"
  ..[idStateRegionalEven] = "RegE"
  ..[idStateRegionalLookahead] = "LARe"
  ..[idStateZWJPictographicLookahead] = "LAZP"
  ..[idStateInCLookahead] = "LAIC"
  ..[idStateInCLLookahead] = "LAIL";
