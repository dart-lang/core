...
const List<(List<String> graphemeClusters, String description)> emojis = [
  ...
  (['\u{1f004}'], 'E0.6   [1] (🀄)       mahjong red dragon'),
  (['\u{1f0cf}'], 'E0.6   [1] (🃏)       joker'),
  (['\u{1f18e}'], 'E0.6   [1] (🆎)       AB button (blood type)'),
  (['\u{1f21a}'], 'E0.6   [1] (🈚)       Japanese “free of charge” button'),
  (['\u{1f22f}'], 'E0.6   [1] (🈯)       Japanese “reserved” button'),
  (['\u{1f30f}'], 'E0.6   [1] (🌏)       globe showing Asia-Australia'),
  (['\u{1f310}'], 'E1.0   [1] (🌐)       globe with meridians'),
  (['\u{1f311}'], 'E0.6   [1] (🌑)       new moon'),
  (['\u{1f312}'], 'E1.0   [1] (🌒)       waxing crescent moon'),
  (['\u{1f319}'], 'E0.6   [1] (🌙)       crescent moon'),
  (['\u{1f31a}'], 'E1.0   [1] (🌚)       new moon face'),
  (['\u{1f31b}'], 'E0.6   [1] (🌛)       first quarter moon face'),
  (['\u{1f31c}'], 'E0.7   [1] (🌜)       last quarter moon face'),
  (['\u{1f321}'], 'E0.7   [1] (🌡️)       thermometer'),
  (['\u{1f336}'], 'E0.7   [1] (🌶️)       hot pepper'),
  (['\u{1f34b}'], 'E1.0   [1] (🍋)       lemon'),
  (['\u{1f350}'], 'E1.0   [1] (🍐)       pear'),
  (['\u{1f37c}'], 'E1.0   [1] (🍼)       baby bottle'),
  (['\u{1f37d}'], 'E0.7   [1] (🍽️)       fork and knife with plate'),
  (['\u{1f3c5}'], 'E1.0   [1] (🏅)       sports medal'),
  (['\u{1f3c6}'], 'E0.6   [1] (🏆)       trophy'),
  (['\u{1f3c7}'], 'E1.0   [1] (🏇)       horse racing'),
  (['\u{1f3c8}'], 'E0.6   [1] (🏈)       american football'),
  (['\u{1f3c9}'], 'E1.0   [1] (🏉)       rugby football'),
  (['\u{1f3ca}'], 'E0.6   [1] (🏊)       person swimming'),
  (['\u{1f3e4}'], 'E1.0   [1] (🏤)       post office'),
  (['\u{1f3f3}'], 'E0.7   [1] (🏳️)       white flag'),
  (['\u{1f3f4}'], 'E1.0   [1] (🏴)       black flag'),
  (['\u{1f3f5}'], 'E0.7   [1] (🏵️)       rosette'),
  (['\u{1f3f7}'], 'E0.7   [1] (🏷️)       label'),
  (['\u{1f408}'], 'E0.7   [1] (🐈)       cat'),
  (['\u{1f413}'], 'E1.0   [1] (🐓)       rooster'),
  (['\u{1f414}'], 'E0.6   [1] (🐔)       chicken'),
  (['\u{1f415}'], 'E0.7   [1] (🐕)       dog'),
  (['\u{1f416}'], 'E1.0   [1] (🐖)       pig'),
  (['\u{1f42a}'], 'E1.0   [1] (🐪)       camel'),
  (['\u{1f43f}'], 'E0.7   [1] (🐿️)       chipmunk'),
  (['\u{1f440}'], 'E0.6   [1] (👀)       eyes'),
  (['\u{1f441}'], 'E0.7   [1] (👁️)       eye'),
  (['\u{1f465}'], 'E1.0   [1] (👥)       busts in silhouette'),
  (['\u{1f4ad}'], 'E1.0   [1] (💭)       thought balloon'),
  (['\u{1f4ee}'], 'E0.6   [1] (📮)       postbox'),
  (['\u{1f4ef}'], 'E1.0   [1] (📯)       postal horn'),
  (['\u{1f4f5}'], 'E1.0   [1] (📵)       no mobile phones'),
  (['\u{1f4f8}'], 'E1.0   [1] (📸)       camera with flash'),
  (['\u{1f4fd}'], 'E0.7   [1] (📽️)       film projector'),
  (['\u{1f503}'], 'E0.6   [1] (🔃)       clockwise vertical arrows'),
  (['\u{1f508}'], 'E0.7   [1] (🔈)       speaker low volume'),
  (['\u{1f509}'], 'E1.0   [1] (🔉)       speaker medium volume'),
  (['\u{1f515}'], 'E1.0   [1] (🔕)       bell with slash'),
  (['\u{1f57a}'], 'E3.0   [1] (🕺)       man dancing'),
  (['\u{1f587}'], 'E0.7   [1] (🖇️)       linked paperclips'),
  (['\u{1f590}'], 'E0.7   [1] (🖐️)       hand with fingers splayed'),
  (['\u{1f5a4}'], 'E3.0   [1] (🖤)       black heart'),
  (['\u{1f5a5}'], 'E0.7   [1] (🖥️)       desktop computer'),
  (['\u{1f5a8}'], 'E0.7   [1] (🖨️)       printer'),
  (['\u{1f5bc}'], 'E0.7   [1] (🖼️)       framed picture'),
  (['\u{1f5e1}'], 'E0.7   [1] (🗡️)       dagger'),
  (['\u{1f5e3}'], 'E0.7   [1] (🗣️)       speaking head'),
  (['\u{1f5e8}'], 'E2.0   [1] (🗨️)       left speech bubble'),
  (['\u{1f5ef}'], 'E0.7   [1] (🗯️)       right anger bubble'),
  (['\u{1f5f3}'], 'E0.7   [1] (🗳️)       ballot box with ballot'),
  (['\u{1f5fa}'], 'E0.7   [1] (🗺️)       world map'),
  (['\u{1f600}'], 'E1.0   [1] (😀)       grinning face'),
  (['\u{1f60e}'], 'E1.0   [1] (😎)       smiling face with sunglasses'),
  (['\u{1f60f}'], 'E0.6   [1] (😏)       smirking face'),
  (['\u{1f610}'], 'E0.7   [1] (😐)       neutral face'),
  (['\u{1f611}'], 'E1.0   [1] (😑)       expressionless face'),
  (['\u{1f615}'], 'E1.0   [1] (😕)       confused face'),
  (['\u{1f616}'], 'E0.6   [1] (😖)       confounded face'),
  (['\u{1f617}'], 'E1.0   [1] (😗)       kissing face'),
  (['\u{1f618}'], 'E0.6   [1] (😘)       face blowing a kiss'),
  (['\u{1f619}'], 'E1.0   [1] (😙)       kissing face with smiling eyes'),
  (['\u{1f61a}'], 'E0.6   [1] (😚)       kissing face with closed eyes'),
  (['\u{1f61b}'], 'E1.0   [1] (😛)       face with tongue'),
  (['\u{1f61f}'], 'E1.0   [1] (😟)       worried face'),
  (['\u{1f62c}'], 'E1.0   [1] (😬)       grimacing face'),
  (['\u{1f62d}'], 'E0.6   [1] (😭)       loudly crying face'),
  (['\u{1f634}'], 'E1.0   [1] (😴)       sleeping face'),
  (['\u{1f635}'], 'E0.6   [1] (😵)       face with crossed-out eyes'),
  (['\u{1f636}'], 'E1.0   [1] (😶)       face without mouth'),
  (['\u{1f680}'], 'E0.6   [1] (🚀)       rocket'),
  (['\u{1f686}'], 'E1.0   [1] (🚆)       train'),
  (['\u{1f687}'], 'E0.6   [1] (🚇)       metro'),
  (['\u{1f688}'], 'E1.0   [1] (🚈)       light rail'),
  (['\u{1f689}'], 'E0.6   [1] (🚉)       station'),
  (['\u{1f68c}'], 'E0.6   [1] (🚌)       bus'),
  (['\u{1f68d}'], 'E0.7   [1] (🚍)       oncoming bus'),
  (['\u{1f68e}'], 'E1.0   [1] (🚎)       trolleybus'),
  (['\u{1f68f}'], 'E0.6   [1] (🚏)       bus stop'),
  (['\u{1f690}'], 'E1.0   [1] (🚐)       minibus'),
  (['\u{1f694}'], 'E0.7   [1] (🚔)       oncoming police car'),
  (['\u{1f695}'], 'E0.6   [1] (🚕)       taxi'),
  (['\u{1f696}'], 'E1.0   [1] (🚖)       oncoming taxi'),
  (['\u{1f697}'], 'E0.6   [1] (🚗)       automobile'),
  (['\u{1f698}'], 'E0.7   [1] (🚘)       oncoming automobile'),
  (['\u{1f6a2}'], 'E0.6   [1] (🚢)       ship'),
  (['\u{1f6a3}'], 'E1.0   [1] (🚣)       person rowing boat'),
  (['\u{1f6a6}'], 'E1.0   [1] (🚦)       vertical traffic light'),
  (['\u{1f6b2}'], 'E0.6   [1] (🚲)       bicycle'),
  (['\u{1f6b6}'], 'E0.6   [1] (🚶)       person walking'),
  (['\u{1f6bf}'], 'E1.0   [1] (🚿)       shower'),
  (['\u{1f6c0}'], 'E0.6   [1] (🛀)       person taking bath'),
  (['\u{1f6cb}'], 'E0.7   [1] (🛋️)       couch and lamp'),
  (['\u{1f6cc}'], 'E1.0   [1] (🛌)       person in bed'),
  (['\u{1f6d0}'], 'E1.0   [1] (🛐)       place of worship'),
  (['\u{1f6d5}'], 'E12.0  [1] (🛕)       hindu temple'),
  (['\u{1f6dc}'], 'E15.0  [1] (🛜)       wireless'),
  (['\u{1f6e9}'], 'E0.7   [1] (🛩️)       small airplane'),
  (['\u{1f6f0}'], 'E0.7   [1] (🛰️)       satellite'),
  (['\u{1f6f3}'], 'E0.7   [1] (🛳️)       passenger ship'),
  (['\u{1f6f9}'], 'E11.0  [1] (🛹)       skateboard'),
  (['\u{1f6fa}'], 'E12.0  [1] (🛺)       auto rickshaw'),
  (['\u{1f7f0}'], 'E14.0  [1] (🟰)       heavy equals sign'),
  (['\u{1f90c}'], 'E13.0  [1] (🤌)       pinched fingers'),
  (['\u{1f91f}'], 'E5.0   [1] (🤟)       love-you gesture'),
  (['\u{1f930}'], 'E3.0   [1] (🤰)       pregnant woman'),
  (['\u{1f93f}'], 'E12.0  [1] (🤿)       diving mask'),
  (['\u{1f94c}'], 'E5.0   [1] (🥌)       curling stone'),
  (['\u{1f971}'], 'E12.0  [1] (🥱)       yawning face'),
  (['\u{1f972}'], 'E13.0  [1] (🥲)       smiling face with tear'),
  (['\u{1f979}'], 'E14.0  [1] (🥹)       face holding back tears'),
  (['\u{1f97a}'], 'E11.0  [1] (🥺)       pleading face'),
  (['\u{1f97b}'], 'E12.0  [1] (🥻)       sari'),
  (['\u{1f9c0}'], 'E1.0   [1] (🧀)       cheese wedge'),
  (['\u{1f9cb}'], 'E13.0  [1] (🧋)       bubble tea'),
  (['\u{1f9cc}'], 'E14.0  [1] (🧌)       troll'),
  (['\u{1fa74}'], 'E13.0  [1] (🩴)       thong sandal'),
  (['\u{1fa89}'], 'E16.0  [1] (🪉)       harp'),
  (['\u{1fa8f}'], 'E16.0  [1] (🪏)       shovel'),
  (['\u{1fabe}'], 'E16.0  [1] (🪾)       leafless tree'),
  (['\u{1fabf}'], 'E15.0  [1] (🪿)       goose'),
  (['\u{1fac6}'], 'E16.0  [1] (🫆)       fingerprint'),
  (['\u{1fadc}'], 'E16.0  [1] (🫜)       root vegetable'),
  (['\u{1fadf}'], 'E16.0  [1] (🫟)       splatter'),
  (['\u{1fae8}'], 'E15.0  [1] (🫨)       shaking face'),
  (['\u{1fae9}'], 'E16.0  [1] (🫩)       face with bags under eyes'),
  (['\u23f0'], 'E0.6   [1] (⏰)       alarm clock'),
  (['\u23f3'], 'E0.6   [1] (⏳)       hourglass not done'),
  (['\u267f'], 'E0.6   [1] (♿)       wheelchair symbol'),
  (['\u2693'], 'E0.6   [1] (⚓)       anchor'),
  ...
  (['\u{1f0cf}'], 'E0.6   [1] (🃏)       joker'),
  (['\u{1f18e}'], 'E0.6   [1] (🆎)       AB button (blood type)'),
  (['\u{1f201}'], 'E0.6   [1] (🈁)       Japanese “here” button'),
  (['\u{1f21a}'], 'E0.6   [1] (🈚)       Japanese “free of charge” button'),
  (['\u{1f22f}'], 'E0.6   [1] (🈯)       Japanese “reserved” button'),
  (['\u{1f30f}'], 'E0.6   [1] (🌏)       globe showing Asia-Australia'),
  (['\u{1f310}'], 'E1.0   [1] (🌐)       globe with meridians'),
  ...
  (['\u270d'], 'E0.7   [1] (✍️)       writing hand'),
  (['\u{1f385}'], 'E0.6   [1] (🎅)       Santa Claus'),
  (['\u{1f3c7}'], 'E1.0   [1] (🏇)       horse racing'),
  (['\u{1f3ca}'], 'E0.6   [1] (🏊)       person swimming'),
  (['\u{1f47c}'], 'E0.6   [1] (👼)       baby angel'),
  (['\u{1f48f}'], 'E0.6   [1] (💏)       kiss'),
  (['\u{1f491}'], 'E0.6   [1] (💑)       couple with heart'),
  (['\u{1f4aa}'], 'E0.6   [1] (💪)       flexed biceps'),
  (['\u{1f57a}'], 'E3.0   [1] (🕺)       man dancing'),
  (['\u{1f590}'], 'E0.7   [1] (🖐️)       hand with fingers splayed'),
  (['\u{1f6a3}'], 'E1.0   [1] (🚣)       person rowing boat'),
  (['\u{1f6b6}'], 'E0.6   [1] (🚶)       person walking'),
  ...
  (['\u{1f6cc}'], 'E1.0   [1] (🛌)       person in bed'),
  (['\u{1f90c}'], 'E13.0  [1] (🤌)       pinched fingers'),
  (['\u{1f90f}'], 'E12.0  [1] (🤏)       pinching hand'),
  (['\u{1f918}'], 'E1.0   [1] (🤘)       sign of the horns'),
  (['\u{1f91f}'], 'E5.0   [1] (🤟)       love-you gesture'),
  (['\u{1f926}'], 'E3.0   [1] (🤦)       person facepalming'),
  (['\u{1f930}'], 'E3.0   [1] (🤰)       pregnant woman'),
  (['\u{1f977}'], 'E13.0  [1] (🥷)       ninja'),
  (['\u{1f9bb}'], 'E12.0  [1] (🦻)       ear with hearing aid'),
  (['#'], 'E0.0   [1] (#️)       hash sign'),
  (['*'], 'E0.0   [1] (*️)       asterisk'),
  (['\u200d'], 'E0.0   [1] (‍)        zero width joiner'),
  (['\u20e3'], 'E0.0   [1] (⃣)       combining enclosing keycap'),
  (['\ufe0f'], 'E0.0   [1] ()        VARIATION SELECTOR-16'),
  (['©'], 'E0.6   [1] (©️)       copyright'),
  (['®'], 'E0.6   [1] (®️)       registered'),
  (['\u203c'], 'E0.6   [1] (‼️)       double exclamation mark'),
  (['\u2049'], 'E0.6   [1] (⁉️)       exclamation question mark'),
  ...
  (['\u{1f004}'], 'E0.6   [1] (🀄)       mahjong red dragon'),
  (['\u{1f0cf}'], 'E0.6   [1] (🃏)       joker'),
  (['\u{1f12f}'], 'E0.0   [1] (🄯)       COPYLEFT SYMBOL'),
  (['\u{1f18e}'], 'E0.6   [1] (🆎)       AB button (blood type)'),
  (['\u{1f21a}'], 'E0.6   [1] (🈚)       Japanese “free of charge” button'),
  (['\u{1f22f}'], 'E0.6   [1] (🈯)       Japanese “reserved” button'),
  (['\u{1f30f}'], 'E0.6   [1] (🌏)       globe showing Asia-Australia'),
  ...
  (['\u{1f37c}'], 'E1.0   [1] (🍼)       baby bottle'),
  (['\u{1f37d}'], 'E0.7   [1] (🍽️)       fork and knife with plate'),
  (['\u{1f398}'], 'E0.0   [1] (🎘)       MUSICAL KEYBOARD WITH JACKS'),
  (['\u{1f3c5}'], 'E1.0   [1] (🏅)       sports medal'),
  (['\u{1f3c6}'], 'E0.6   [1] (🏆)       trophy'),
  (['\u{1f3c7}'], 'E1.0   [1] (🏇)       horse racing'),
  (['\u{1f3c8}'], 'E0.6   [1] (🏈)       american football'),
  ...
  (['\u{1f4f8}'], 'E1.0   [1] (📸)       camera with flash'),
  (['\u{1f4fd}'], 'E0.7   [1] (📽️)       film projector'),
  (['\u{1f4fe}'], 'E0.0   [1] (📾)       PORTABLE STEREO'),
  (['\u{1f503}'], 'E0.6   [1] (🔃)       clockwise vertical arrows'),
  (['\u{1f508}'], 'E0.7   [1] (🔈)       speaker low volume'),
  (['\u{1f509}'], 'E1.0   [1] (🔉)       speaker medium volume'),
  (['\u{1f515}'], 'E1.0   [1] (🔕)       bell with slash'),
  (['\u{1f54f}'], 'E0.0   [1] (🕏)       BOWL OF HYGIEIA'),
  (['\u{1f57a}'], 'E3.0   [1] (🕺)       man dancing'),
  (['\u{1f587}'], 'E0.7   [1] (🖇️)       linked paperclips'),
  (['\u{1f590}'], 'E0.7   [1] (🖐️)       hand with fingers splayed'),
  (['\u{1f5a4}'], 'E3.0   [1] (🖤)       black heart'),
  ...
  (['\u{1f6dc}'], 'E15.0  [1] (🛜)       wireless'),
  (['\u{1f6e9}'], 'E0.7   [1] (🛩️)       small airplane'),
  (['\u{1f6ea}'], 'E0.0   [1] (🛪)       NORTHEAST-POINTING AIRPLANE'),
  (['\u{1f6f0}'], 'E0.7   [1] (🛰️)       satellite'),
  (['\u{1f6f3}'], 'E0.7   [1] (🛳️)       passenger ship'),
  (['\u{1f6f9}'], 'E11.0  [1] (🛹)       skateboard'),
  (['\u{1f6fa}'], 'E12.0  [1] (🛺)       auto rickshaw'),
