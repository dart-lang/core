...
void testNative(NativePlatform actual, Map<String, Object?> expectedValues) {
  ...
  _testProperty(
    () => actual.executableArguments,
    expectedValues[json_key.executableArguments],
  );
  _testProperty(
    () => actual.lineTerminator,
    expectedValues[json_key.lineTerminator],
  );
  _testProperty(() => actual.localeName, expectedValues[json_key.localeName]);
  _testProperty(
    () => actual.localHostname,
    expectedValues[json_key.localHostname],
  );
  _testProperty(
    () => actual.numberOfProcessors,
  ...
  _testProperty(
    () => actual.pathSeparator,
    expectedValues[json_key.pathSeparator],
  );
  _testProperty(
    () => actual.resolvedExecutable,
  ...
  _testProperty(
    () => actual.stdinSupportsAnsi,
    expectedValues[json_key.stdinSupportsAnsi],
  );
  _testProperty(
    () => actual.stdoutSupportsAnsi,
